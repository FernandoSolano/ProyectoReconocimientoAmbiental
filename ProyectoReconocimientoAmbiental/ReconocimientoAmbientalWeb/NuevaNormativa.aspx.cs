...
{
    public partial class NuevaNormativa : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                using (BinaryReader reader = new BinaryReader(FileUpload1.PostedFile.InputStream))
                {
                    ...
                    normativaBusiness.Insertar(Int32.Parse(DropDownList1.DataValueField), Txt_titulo.Text, txt_fecha.Text ,txt_detalle.Text, FileUpload1.FileName, FileUpload1.PostedFile.ContentType, image);
                }
            }
            Response.Redirect("~/verNormativas.aspx");
        }
    }
}